...
class AddComprehensiveFieldsToProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('projects', function (Blueprint $table) {
            // UNIDAD SOLICITANTE
            $table->string('soliciting_direction_general')->nullable();
            $table->string('soliciting_line_management')->nullable();
            
            // UNIDAD DESTINATARIA
            $table->string('destination_direction_general')->nullable();
            $table->string('destination_line_management')->nullable();
            
            // TIPO Y CODIGO DE REQUERIMIENTO
